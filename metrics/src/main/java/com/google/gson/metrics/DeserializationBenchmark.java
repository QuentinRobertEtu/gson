...
public class DeserializationBenchmark {
  ...
  private boolean isCollec; //isCollec True if this is CollectionsDeserialization False if this is BagOfPrimitives
  ...
  @BeforeExperiment
  void setUp(boolean isCollec) throws Exception {
  ...
  public void timeStreaming(int reps) throws IOException {
    for (int i = 0; i < reps; ++i) {
